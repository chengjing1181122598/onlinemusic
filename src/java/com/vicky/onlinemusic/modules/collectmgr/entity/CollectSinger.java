...
public class CollectSinger implements Serializable {
    ...
    @Column(name = "collect_singer_id")
    private String collectSingerId;
    ...
    /**
     * @return the collectSingerId
     */
    public String getCollectSingerId() {
        return collectSingerId;
    }

    /**
     * @param collectSingerId the collectSingerId to set
     */
    public void setCollectSingerId(String collectSingerId) {
        this.collectSingerId = collectSingerId;
    }
